...
from pg_view.models.clients import read_postmaster_pid, make_cluster_desc, DBConnectionBuilder, DBConnectionFinder, \
    DBClient
...
class DBConnectionFinderTest(TestCase):
    ...
    @mock.patch('pg_view.models.clients.DBConnectionFinder.detect_with_proc_net', return_value=None)
    @mock.patch('pg_view.models.clients.DBConnectionFinder.can_connect_with_connection_arguments', return_value=True)
    @mock.patch('pg_view.models.clients.ProcWorker')
    ...
    @mock.patch('pg_view.models.clients.DBConnectionFinder.detect_with_proc_net')
    @mock.patch('pg_view.models.clients.DBConnectionFinder.can_connect_with_connection_arguments', return_value=True)
    ...
    @mock.patch('pg_view.models.clients.DBConnectionFinder.can_connect_with_connection_arguments')
    ...
    @mock.patch('pg_view.models.clients.logger')
    @mock.patch('pg_view.models.clients.psycopg2.connect', side_effect=psycopg2.OperationalError)
    ...
    @mock.patch('pg_view.models.clients.psycopg2.connect')
    ...
    @mock.patch('pg_view.models.clients.logger')
    @mock.patch('pg_view.models.clients.ProcNetParser')
...
class DBClientTest(TestCase):
    ...
    @mock.patch('pg_view.models.clients.DBConnectionFinder')
    ...
    @mock.patch('pg_view.models.clients.logger')
    @mock.patch('pg_view.models.clients.psycopg2')
    @mock.patch('pg_view.models.clients.read_postmaster_pid')
