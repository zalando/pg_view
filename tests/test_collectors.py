...
from pg_view_os import HostStatCollector
...
class HostStatCollectorTest(TestCase):
    ...
    @mock.patch('pg_view_os.os.getloadavg', return_value=(3.47, 3.16, 2.89))
    ...
    @mock.patch('pg_view_os.socket.gethostname', return_value='Macbook-Pro')
    ...
    @mock.patch('pg_view_os.os.uname', return_value=('Darwin', 'MacBook-Pro', '15.6.0', 'KV 15.6.0: Thu Sep 1 PDT 2016; root:xnu-3248', 'x86_64'))
    ...
    @mock.patch('pg_view_os.cpu_count', return_value=1)
    ...
    @mock.patch('pg_view_os.cpu_count')
    @mock.patch('pg_view_os.logger')
