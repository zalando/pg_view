...
from pg_view.parsers import ProcNetParser, get_dbname_from_path, ProcWorker, connection_params
...
class ProcWorkerTest(TestCase):
    ...
    @mock.patch('pg_view.parsers.ProcWorker._get_postgres_processes')
    @mock.patch('pg_view.parsers.ProcWorker.get_pg_version_from_file')
    ...
    @mock.patch('pg_view.parsers.ProcWorker._get_postgres_processes')
    @mock.patch('pg_view.parsers.ProcWorker.get_pg_version_from_file', return_value=None)
    ...
    @mock.patch('pg_view.parsers.psutil.process_iter')
    ...
    @mock.patch('pg_view.parsers.os.access', return_value=True)
    @mock.patch('pg_view.parsers.read_file', return_value='9.3\n')
    @mock.patch('pg_view.parsers.logger')
    ...
    @mock.patch('pg_view.parsers.os.access', return_value=True)
    @mock.patch('pg_view.parsers.read_file', return_value='9')
    @mock.patch('pg_view.parsers.logger')
    ...
    @mock.patch('pg_view.parsers.os.access', return_value=True)
    @mock.patch('pg_view.parsers.read_file', side_effect=os.error)
    @mock.patch('pg_view.parsers.logger')
