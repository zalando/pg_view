...
class GetDisplayerByClassTest(TestCase):
    ...
    @mock.patch('pg_view.models.outputs.JsonDisplayer.from_collector')
    ...
    @mock.patch('pg_view.models.outputs.ConsoleDisplayer.from_collector')
    ...
    @mock.patch('pg_view.models.outputs.CursesDisplayer.from_collector')
